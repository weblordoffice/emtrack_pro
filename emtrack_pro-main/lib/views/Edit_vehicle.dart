...
import 'package:yokohama_emtrack/controllers/update_vehicle_controller.dart';
import 'package:yokohama_emtrack/utils/secure_storage.dart';
import 'package:yokohama_emtrack/widgets/vehicle_daigram_Rotate_tyres.dart';
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                    ...
                    onTap: () {
                      _openFullScreenDialog(
                        ...
                        onSelect: (item) {
                          ...
                          /// 👇 UI me uppercase show hoga
                          vc.manufacturerCtrl.text = item.toUpperCase();
                ...
                decoration: InputDecoration(
                  ...
                  suffixIcon: Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          vc.removalTreadCtrl.clear();
                          vc.removalTread.value = "";

                          /// 🔥 SHOW VALIDATION
                          vc.removalTreadError.value = "This field is required";
                        },
                        child: const Padding(
                          padding: EdgeInsets.only(right: 8),
                          child: Icon(
            ...
            InkWell(
              onTap: () async {
                print("🆔 VEHICLE ID BEFORE UPDATE => ${vc.vehicleId}");
                await vc.updateForm();
              },
              child: Container(
