...
import 'package:yokohama_emtrack/views/search_install_view.dart';
...
class _VehicleDiagramState extends State<VehicleDiagram> {
  ...
  Widget _tyre(InstalledTire tire) {
    ...
    return InkWell(
      ...
      child: Column(
        children: [
          VehicleDiagram._serial(tire.tireSerialNo ?? ""),
          ...
          Container(
            ...
            child: Column(
              children: [
                VehicleDiagram._percent("$percent%", borderColor),
                const SizedBox(height: 10),
                VehicleDiagram._value(
                  'P',
                ...
                VehicleDiagram._value('Ti', tire.insideTread?.toString() ?? ''),
              ],
            ),
          ),
