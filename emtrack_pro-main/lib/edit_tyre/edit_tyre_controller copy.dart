...
import 'package:yokohama_emtrack/create_tyre/app_loader.dart';
import 'package:yokohama_emtrack/edit_tyre/edit_tyre_model.dart';
import 'package:yokohama_emtrack/edit_tyre/edit_tyre_service.dart';
...
class EditTyreController extends GetxController {
  ...
  void onInit() {
    ...
    loadMasterData().then((_) {
      loadTyreDetails(); // 👈 master ke baad
    });
  ...
  Future<void> loadTyreDetails() async {
    try {
      ...
      setDropdownById(
        ...
        idList: statusIdList.toList(),
        nameList: statusList.toList(),
