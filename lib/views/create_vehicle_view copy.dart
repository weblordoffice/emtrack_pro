            ...
            Obx(
              () => TextField(
                ...
                decoration: InputDecoration(
                  ...
                  /// ❌ SUFFIX ICON
                  suffixIcon: vc.currentHoursCtrl.text.isNotEmpty
                      ? IconButton(
...
<<<<<<< HEAD
                ...
                onChanged: (v) {
                  ...
                  // FIX: Live validation — decimal value pe message dikhao
                  if (v.trim().isEmpty) {
                    ...
                    // Decimal entered — valid hai but sirf 1 digit baad mein
                    final parts = v.split('.');
                    if (parts[1].length > 1) {
                      vc.removalTreadError.value =
                      "Only 1 digit allowed after decimal";
                    } else {
                      vc.removalTreadError.value = ''; // valid decimal
                    }
                  } else {
